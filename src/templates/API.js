...
export { default as DESCRIPTION_SUMMARY_FIELD } from "./json/descriptionSummaryField.json";
export { default as COLLECTIONS_SUMMARY_FIELD } from "./json/collectionsSummaryField.json";
