    ...
    children: [
        ...
        children: [
          {
            ...
            data: {
              data: [
                ...
                {
                  title:
                    "Should I use the “Search Both Archives and Artifacts Collections,” or the specific Archives Search Page / Artifacts Search Page?",
                  description:
                    "We recommend using the “Search Both Archives and Artifacts Collections” if you’re interested in a variety of formats. Click on the Archives Search Page if you only want to view documents, photographs, audio recordings, or maps. Just interested in objects like clothing, furniture, and tools? Use the Artifacts Search Page.",
                },
                {
                  title: "I can’t find what I’m looking for - what do I do?",
                  description:
                    "Please contact archives@surrey.ca or 604.502.6459 and we’ll be happy to help you find the information you’re looking for. We are always adding to the database but only a fragment of our collections, spanning millions of items, are available online.",
                },

                {
                  title: "Can I see these things in person?",
                  description:
                    "Yes, you can! Items in the archival collection can be seen at the Surrey Archives, and objects in the Artifacts Collection may be viewed at the Museum of Surrey or the Historic Stewart Farm. We encourage you to get in touch with staff to ensure the items are available for viewing during your visit.",
                },

                {
                  title: "I’ve spotted an error. Can I tell someone?",
                  description:
                    "Please do! We appreciate feedback and always welcome corrections and comments as they help expand our shared knowledge of Surrey’s past and maintain accuracy. Contact us at archives@surrey.ca or 604.502.6459 and your message will be directed to the appropriate staff member.",
                },
                ...
                {
                  title:
                    "I have something I think you might want. How can I donate?",
                  description:
                    "Thank you so much for considering Surrey Heritage Collections. We look forward to hearing from you and learning about your item(s). Please email HeritageCollections@surrey.ca to start the donation process.",
                },

                {
                  title:
                    "I want to learn about how to best care for my family/community items – how can I do this?",
                  description:
                    "There are some useful online resources to help get you started: -	The Canadian Conversation Institute offers a wide range of publications on the care of archival records and heritage materials. -	The Canadian Heritage Information Network provides resources on digital preservation and collections management. -	The North East Document Conservation Centre has various online leaflets for the care of archival and library resources. Please contact us at HeritageCollections@surrey.ca for further information.",
                },
              ],
            },
          },
...

      {
        ...
        data: {
          ...
          description:
            "You can purchase copies of photographs, maps, and recordings from the archival collection by following these steps:",
        },
        children: [
          {
            ...
            data: {
              position: 0,
              thumbnail:
                "http://surrey.minisisinc.com/surrey/images/ordering-1.jpg",
          ...
          },
          {
            ...
            data: {
              position: 0,
              thumbnail:
                "http://surrey.minisisinc.com/surrey/images/ordering-2.jpg",
              description:
                "Click on the item that you are interested in on the summary search results page.",
              textAlign: "left",
            },
          },
          {
            ...
            data: {
              position: 0,
              thumbnail:
                "http://surrey.minisisinc.com/surrey/images/ordering-3.jpg",
              description:
                "When the detailed record view comes up, click on the order button at the end of the record and ﬁll out the form. We will contact you to complete your order.",
              textAlign: "left",
            },
          },
        ],
