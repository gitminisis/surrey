...
export const COLLECTIONS_SUMMARY_FIELD = [{
    ...
    },
    {
        ...
        data: { name: "OBJ_DESCRIPTION", label: "Description", showLabel: true },
        gridDisplay: false,
        // maxLength: 200,
    },
];
...
export const GENERAL_SEARCHBOX_DBLIST = [{
        ...
        searchURL: "?UNIONSEARCH&KEEP=Y&SIMPLE_EXP=Y&ERRMSG=[MESSAGES]374.htm&APPLICATION=UNION_VIEW&language=144&REPORT=WEB_UNION_SUM",
    },
    {
        database: "Archives",
        searchURL: "?UNIONSEARCH&KEEP=Y&SIMPLE_EXP=Y&ERRMSG=[MESSAGES]374.htm&APPLICATION=UNION_VIEW&DATABASE=DESCRIPTION&language=144&REPORT=WEB_UNION_SUM_DESC",
    },
    {
        database: "Artifact",
        searchURL: "?UNIONSEARCH&KEEP=Y&SIMPLE_EXP=Y&ERRMSG=[MESSAGES]374.htm&APPLICATION=UNION_VIEW&DATABASE=COLLECTIONS&language=144&REPORT=WEB_UNION_SUM_COL",
    },
];
